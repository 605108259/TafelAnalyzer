...
class BatchExportWorker(QThread):
    ...
    finished = Signal(int, int, list)  # success_count, fail_count, failed_paths
    error = Signal(str)
    ...
    def run(self) -> None:
        ...
        self.finished.emit(success, fail, failed)
...
class ExportController(BaseAppController):
    ...
    def _on_batch_finished(self, success: int, fail: int, failed: list) -> None:
